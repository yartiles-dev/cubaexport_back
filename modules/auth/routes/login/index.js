...
const {findUser, DateTimeZoneWithOutDate, DateTimezone, findUserWithOutRoleByEmail} = require("../../../../common/utils/helpers-method");
        ...
        jwt.verify(bearer, global.app.config.get('jwt:secret'), {
            ...
            function(err,
                ...
                if (err) {
                    ...
                    return findUserWithOutRoleByEmail(decoded.data.email)
                        .then(function (user) {
                        if (!user) {
                            return res.status(401).json({
                                errors: [{
